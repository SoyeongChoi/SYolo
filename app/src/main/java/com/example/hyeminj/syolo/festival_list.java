...
public class festival_list extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listView = (ListView) findViewById(R.id.listview_f);
        ...
        boolean inAGE = false, inCodename = false, inEtc = false, inHomepage = false, inTitle = false, inStart = false,
                ...
                inLink = false, inImg = false, inTarget = false, inFee = false, inProgram = false;
                ...
                switch (parserEvent) {
                    ...
                    case XmlPullParser.END_TAG:
                        if (parser.getName().equals("row")) {
                            if (codename.contains("축제") || codename.contains("콘서트")) {
