...
public class musical_list extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_musical_list);
        ListView listView = (ListView)findViewById(R.id.listview_m);
                ...
                switch (parserEvent) {
                    ...
                    case XmlPullParser.END_TAG:
                        if (parser.getName().equals("row")) {
                            ...
                            /* mDatabase.child("Culture").child(i_string).child("연령").setValue(age);*/
                        }
                        break;
                }
