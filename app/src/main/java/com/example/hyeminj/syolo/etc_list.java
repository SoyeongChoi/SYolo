...
public class etc_list extends AppCompatActivity implements SearchView.OnQueryTextListener {
                ...
                switch (parserEvent) {
                    ...
                    case XmlPullParser.END_TAG:
                        if (parser.getName().equals("row")) {
                            if(!(codename.contains("뮤지컬")||codename.contains("축제")||codename.contains("연극")||codename.contains("콘서트")||codename.contains("전시"))){
